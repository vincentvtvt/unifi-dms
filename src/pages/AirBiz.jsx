...
export default function AirBiz() {
  ...
  return (
    <>
      <PageHero icon={I.wifi(T.primary,28)} tag="Wireless Connectivity" title="Unifi Air Biz 5G" subtitle="Wireless 5G broadband — plug-and-play, no wiring needed. Perfect for shops, pop-ups, and offices without fibre." />
      <section style={{padding:"0 24px 60px",maxWidth:700,margin:"0 auto"}}>
        ...
        <div style={{marginTop:32,display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(200px,1fr))",gap:14}}>
          {[{i:I.zap,t:"Plug & Play",d:"No wiring. Set up in minutes."},{i:I.globe,t:"Portable",d:"Move when your business moves."},{i:I.wifi,t:"5G Speeds",d:"Blazing fast unlimited data."},{i:I.shield,t:"Backup Ready",d:"Primary or backup line."}].map(f=>(
