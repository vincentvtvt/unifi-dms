...
export const Footer = () => {
  ...
  return <footer style={{padding:"48px 24px 28px",borderTop:`1px solid ${T.border}`,background:T.sub}}>
    <div style={{maxWidth:1000,margin:"0 auto",display:"flex",flexWrap:"wrap",gap:32,justifyContent:"space-between"}}>
      ...
      <div style={{minWidth:180}}><div style={{fontSize:12,fontWeight:700,color:T.text,marginBottom:8}}>Contact</div><WaBtn text="WhatsApp Us" msg="I have a question about Unifi products." utm="footer" sm style={{fontSize:11,padding:"7px 14px",marginBottom:8}} /><p style={{fontSize:12,color:T.muted,marginTop:4}}>Available 24/7</p><p style={{fontSize:12,color:T.muted,marginTop:4}}>All 13 states + 3 FT</p></div>
    </div>
