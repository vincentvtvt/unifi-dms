...
export function ThemeProvider({ children }) {
  ...
  useEffect(()=>{
    ...
    setDk(m.matches);const h=e=>setDk(e.matches);
...
const NAV_LINKS=[{l:"Internet",h:"#solutions"},{l:"Mobile",h:"#solutions"},{l:"DMS",h:"#dms-finder"},{l:"AI Chatbot",h:"#chatbot"},{l:"Coverage",h:"#coverage"}];
export const Nav = () => {
  ...
  return <nav style={{position:"fixed",top:0,left:0,right:0,zIndex:1000,background:T.navBg,backdropFilter:"blur(16px)",boxShadow:T.navShadow,height:60}}>
    <div style={{maxWidth:1200,margin:"0 auto",padding:"0 20px",height:"100%",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
      ...
      <div style={{display:"flex",alignItems:"center",gap:10}}>
        <button onClick={T.__toggle} style={{background:"none",border:`1px solid ${T.border}`,borderRadius:8,padding:"5px 7px",cursor:"pointer",display:"flex",alignItems:"center",color:T.muted}}>{T.__dk?Icons.sun():Icons.moon()}</button>
